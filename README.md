...
| `vm-infra` | `111` | `192.168.11.11` | 常時起動 | インフラ基盤 | CoreDNS, Caddy, WireGuard |
...
| FQDN | 宛先 | 用途 | 状態 |
| --- | --- | --- | --- |
| `pve.lab.kanare.dev` | `192.168.11.10` | Proxmox Web UI | 利用中 |
| `infra.lab.kanare.dev` | `192.168.11.11` | `vm-infra` 管理用 | 利用中 |
| `grafana.lab.kanare.dev` | `192.168.11.13` | Grafana | 利用中 |
| `prometheus.lab.kanare.dev` | `192.168.11.13` | Prometheus | 利用中 |
| `dev.lab.kanare.dev` | `192.168.11.21` | `vm-dev` | 任意起動 |
| `apps.lab.kanare.dev` | `192.168.11.20` | 将来のアプリ VM | 予約 |
